...
public class UserApiController implements UserApi {
    ...
    public ResponseEntity<Void> userUserIdDelete(@Parameter(in = ParameterIn.PATH, description = "The ID of an user.", required=true, schema=@Schema()) @PathVariable("userId") Integer userId) {
